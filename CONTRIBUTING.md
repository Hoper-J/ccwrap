...
- **Bilingual docs** — `README.md` (Simplified Chinese, default) pairs with `README.en.md`, and `CONTRIBUTING.md` (English) pairs with `CONTRIBUTING.zh-CN.md`; keep both sides of a pair in sync.
